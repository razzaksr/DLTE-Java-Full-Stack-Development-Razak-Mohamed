...
<fd:setDataSource var="connection" url="jdbc:oracle:thin:@localhost:1521:xe" driver="oracle.jdbc.driver.OracleDriver" user="system" password="admin" />
<%--<fd:query var="qry" dataSource="${connection}" sql="select * from kyc"/>--%>
<fd:query var="qry" sql="select * from kyc" dataSource="${applicationScope.connection}" />
